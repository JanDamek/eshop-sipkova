 ...
 */
abstract class BaseWebPayFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'requestUrl'     => new sfWidgetFormFilterInput(),
      'merchantNumber' => new sfWidgetFormFilterInput(),
      'publicKey'      => new sfWidgetFormFilterInput(),
      'privateKey'     => new sfWidgetFormFilterInput(),
      'heslo'          => new sfWidgetFormFilterInput(),
      'lastOrderNum'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'merchantNumber' => new sfValidatorPass(array('required' => false)),
      'publicKey'      => new sfValidatorPass(array('required' => false)),
      'privateKey'     => new sfValidatorPass(array('required' => false)),
      'heslo'          => new sfValidatorPass(array('required' => false)),
      'lastOrderNum'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('web_pay_filters[%s]');
