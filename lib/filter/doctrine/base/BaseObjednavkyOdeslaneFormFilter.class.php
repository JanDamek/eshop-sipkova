...
/**
 * ObjednavkyOdeslane filter form base class.
 *
 * @package    E Shop
 * @subpackage filter
 ...
 */
abstract class BaseObjednavkyOdeslaneFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('objednavky_odeslane_filters[%s]');
