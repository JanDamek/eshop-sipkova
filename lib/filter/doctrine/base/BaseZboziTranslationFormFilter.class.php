...
/**
 * ZboziTranslation filter form base class.
 *
 ...
 */
abstract class BaseZboziTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zbozi_translation_filters[%s]');
