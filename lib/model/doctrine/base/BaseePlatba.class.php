 ...
 * @method ePlatba    setId()             Sets the current record's "id" value
 * @method ePlatba    setRequestUrl()     Sets the current record's "requestUrl" value
 * @method ePlatba    setShopname()       Sets the current record's "shopname" value
 * @method ePlatba    setCreditaccount()  Sets the current record's "creditaccount" value
 * @method ePlatba    setCreditbank()     Sets the current record's "creditbank" value
 * @method ePlatba    setMenaId()         Sets the current record's "mena_id" value
 * @method ePlatba    setZemeUrceniId()   Sets the current record's "zeme_urceni_id" value
 * @method ePlatba    setEnabled()        Sets the current record's "enabled" value
 * @method ePlatba    setImg()            Sets the current record's "img" value
 * @method ePlatba    setMena()           Sets the current record's "Mena" value
 * @method ePlatba    setZemeUrceni()     Sets the current record's "ZemeUrceni" value
 * 
 * @package    E Shop
 * @subpackage model
 ...
 */
abstract class BaseePlatba extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('e_platba');
