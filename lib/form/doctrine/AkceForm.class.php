 ...
 */
class AkceForm extends BaseAkceForm {
...
//                )));
        ...
        $this->setWidget('platne_od', new sfWidgetFormJQueryDate);
        $this->setWidget('platne_do', new sfWidgetFormJQueryDate);
...
//                )));
//
//        $this->setWidget('zbozi_id', new sfWidgetFormDoctrineJQueryAutocompleter(array(
//                    'model' => 'Zbozi',
//                    'url' => '/backend.php/zbozi/ajaxGallery'
//                )));

        $this->setWidget('kategorie_id', 
                new sfWidgetFormDoctrineChoiceGrouped(
