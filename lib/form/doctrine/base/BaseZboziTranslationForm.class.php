...
/**
 * ZboziTranslation form base class.
 *
 * @method ZboziTranslation getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseZboziTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zbozi_translation[%s]');
