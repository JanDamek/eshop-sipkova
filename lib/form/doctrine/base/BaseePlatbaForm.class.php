...
/**
 * ePlatba form base class.
 *
 * @method ePlatba getObject() Returns the current form's model object
 *
 * @package    E Shop
 * @subpackage form
 ...
 */
abstract class BaseePlatbaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('e_platba[%s]');
