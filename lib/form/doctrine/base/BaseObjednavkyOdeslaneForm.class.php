...
/**
 * ObjednavkyOdeslane form base class.
 *
 * @method ObjednavkyOdeslane getObject() Returns the current form's model object
 *
 * @package    E Shop
 * @subpackage form
 ...
 */
abstract class BaseObjednavkyOdeslaneForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'ObjednavkyOdeslane', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('objednavky_odeslane[%s]');
