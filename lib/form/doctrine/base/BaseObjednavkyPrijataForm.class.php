...
/**
 * ObjednavkyPrijata form base class.
 *
 * @method ObjednavkyPrijata getObject() Returns the current form's model object
 *
 * @package    E Shop
 * @subpackage form
 ...
 */
abstract class BaseObjednavkyPrijataForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'ObjednavkyPrijata', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('objednavky_prijata[%s]');
