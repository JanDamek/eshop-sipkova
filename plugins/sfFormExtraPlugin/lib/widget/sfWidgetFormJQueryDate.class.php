...
class sfWidgetFormJQueryDate extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('config', '{firstDay: 1, changeMonth: true, changeYear: true}');
    $this->addOption('culture', sfContext::getInstance()->getUser()->getCulture()); // vychopzi kultura dle uzivatele
    ...
    if ('cs' == $this->getOption('culture'))
    {
      $this->setOption('culture', 'cs');
    }
  }
